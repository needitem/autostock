...
def test_selector_stock_portfolio_picks_individual_names_only():
    out = bt._selector_stock_portfolio(
        candidates=[
            {
                "symbol": "NVDA",
                "return_63d": 18.0,
    ...
    assert out["_selector_mode"] is True
...
def test_selector_stock_portfolio_sits_out_when_too_few_eligible_names():
    out = bt._selector_stock_portfolio(
        candidates=[
            {
                "symbol": "NVDA",
