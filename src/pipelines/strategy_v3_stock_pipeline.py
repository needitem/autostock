"""Helpers to run and inspect the checked-in Strategy V3 stock-first baseline."""
...
RUNNER_SCRIPT = ROOT_DIR / "scripts" / "run_strategy_v3_stock_selector.py"
...
def latest_strategy_v3_stock_snapshot() -> dict[str, Any]:
...
def run_strategy_v3_stock_pipeline(run_verify: bool = True) -> dict[str, Any]:
    ...
    payload = latest_strategy_v3_stock_snapshot()
